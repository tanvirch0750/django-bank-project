...
class UserUpdateForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            user_account, created = UserBankAccount.objects.get_or_create(user=user) # if user accoutn exist it will go to user account else it will create and go to created 
